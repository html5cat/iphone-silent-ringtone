...
updated from https://github.com/pbaity/silent-ringtone-iphone

[Silence-29.m4r](https://github.com/html5cat/iphone-silent-ringtone/blob/main/Silence-29.m4r)
...
To set this up for yourself, clone this repo or download [Silence-29.m4r](https://github.com/html5cat/iphone-silent-ringtone/blob/main/Silence-29.m4r). Transfer the ringtone to your iPhone (you can drag and drop it into iTunes, for instance), then set your ringtone to "Silence." Turn on "Vibrate on ring" and turn off "Vibrate on silent." Then just make sure all other notifications are set up to vibrate only. 
